...
/* or:
	...
	gen c_earlybreast_  = inlist(m34,0,100) if !inlist(m34,199,299,.)  // code . if m34 or m4 missing
	replace c_earlybreast_ = 0 if m4 ==94  // code 0 if no breastfeeding
*/  
